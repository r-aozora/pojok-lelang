            ...
            <div class="card text-black" style="border-radius: 20px">
              <div class="row g-0">
                <div class="col-sm-6 px-0 d-none d-sm-block">
                  <img src="../dist/img/brand-logo-1.jpeg"
        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
          <div class="col-xl-9">
            <div class="card text-black " style="border-radius:0%">
              <div class="row g-0">
                <div class="col-sm-6 px-0 d-none d-sm-block">
                  <img src="../dist/img/Brand-Logo-Dark.png"
                    alt="Pojok Lelang Logo" class="w-100 h-100" style="object-fit: cover; nheight: 100%; ">
                </div>
                <div class="col-lg-6">
...
<<<<<<< HEAD
                    ...
                    <form>
                      ...
                      <div class=" pt-1 mb-5 pb-1">
                        <button class="btn btn-block fa-lg text-white" style="background-color: #00ADB5" type="button">Masuk</button>
                      </div>
