...
@section('content')
    <div class="container">
        <h3 class="mt-3">Data Masyarakat</h3>
        <div class="row">
            <div class="col">
                <div class="card mt-3 mb-3">
                    <div class="card-body">
                        <div class="card-header" style="background-color:#055E68; max-height:60px">
                            <h5 class="card-title mt-2 fw-medium text-light">Data Masyarakat</h5>
                        </div>
                        ...
                        <div class="text-end col-6 col-lg-6 me-lg-auto">
                            <button type="button" class="btn text-white" data-bs-toggle="modal" data-bs-target="#tambahMasyarakat" style="background-color: #055E68">
                                <i class="bi bi-plus"></i> Tambah
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" id="tambahMasyarakat" tabindex="-1" aria-labelledby="tambahMasyarakat" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header" style="background-color: #055E68">
                                            <h5 class="modal-title text-light" id="tambahMasyarakat">Tambah Data Masyarakat</h5>
                                        </div>
                                    <div class="modal-body">
                                        <div class="form-floating mb-3">
                                            <input type="text" id="id" class="form-control" placeholder="ID Masyarakat">
                                        ...
                                        <div class="form-floating mb-3">
                                            <select class="form-select" id="level" id="level" aria-placeholder="Level">                                                
