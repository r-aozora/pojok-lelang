                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach ($barang as $item)
                                        <tr>
                                            <td><a href="{{ url('barang/'.$item->id) }}">{{ $item->id_barang }}</a></td>
                                            <td><a href="{{ url('barang/'.$item->id) }}">{{ $item->nama_batang }}</a></td>
                                            <td><a href="{{ url('barang/'.$item->id) }}">{{ $item->create_at }}</a></td>
                                            <td><a href="{{ url('barang/'.$item->id) }}">{{ $item->harga_awal }}</a></td>
                                            <td>
