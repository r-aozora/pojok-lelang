                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="{{ url('petugas/'.$item->id) }}" class="btn btn-sm dropdown-item " role="button"><i class="bi bi-clipboard"></i> Detail</a>
                                            </li>
                                            <li>
                                                <a href="{{ url('petugas/'.$item->id.'/edit') }}" class="btn btn-sm dropdown-item"><i class="bi bi-pencil-square"></i> Edit</a>
                                            </li>
                                            <li>
                                                <form onsubmit="return confirm('Data Akan Dihapus')" action="{{ url('petugas/'.$item->id) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
