    ...
    <body>
        <header>
            ...
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    <a href="/" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none fw-bold" style="font-size: 25px">POJOK_ LELANG</a>
                <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                    ...
                    <li>
                        <a href="{{ url('/product') }}" class="nav-link text-white">
                            PRODUCT
                        </a>
                    </li>
                    <li>
        ...
        <footer class="mt-auto">
                <div class="text-center p-3" style="background-color:#055E68" >
                    <p class="text-white" style="text-decoration: none">Copyright &copy; 2023 POJOK_ LELANG. All rights reserved.</p>
                </div>
        </footer>
